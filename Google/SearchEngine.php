...
class SearchEngine
{
    ...
    /**
     * @var SearchEngine_AdapterInterface
     */
    protected $adapter;
    ...
    public function __construct($query = null)
    {
        ...
        $this->adapter = new SearchEngine_Adapter_Curl();
    }
     ...
     * it into a SearchEngine_Response.
     *
     * @return SearchEngine_Response
     */
    public function getResponse()
    {
        ...
        if (!class_exists('SearchEngine_Response', true))
        {
        ...
        $response = new SearchEngine_Response($this->executeApiRequest());
     ...
     *
     * @return SearchEngine_AdapterInterface
     */
     ...
     *
     * @param SearchEngine_AdapterInterface $adapter
     * @return SearchEngine
     */
    public function setAdapter(SearchEngine_AdapterInterface $adapter)
    {
