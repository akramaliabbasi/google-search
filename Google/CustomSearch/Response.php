...
/**
 * SearchEngine_Response parses and formats the raw API response
 *
 * @author Akram Abbasi <mohdakramabbasi@gmail.com>
 */
class SearchEngine_Response
{
    // ------------------------------------------------------
    // Constants
    // ------------------------------------------------------
    ...
    /**
     * @var SearchEngine_Response_Context
     */
    protected $context;
    ...
    /**
     * Creates a new SearchEngine_Response
     *
    ...
    protected function parse($apiResponse)
    {
        ...
        if (!($response instanceof stdClass))
        {
            throw new SearchEngine_ErrorException(
                ...
                SearchEngine_ErrorException::RESPONSE_JSON_INVALID
            );
        }
        ...
        if (isset($response->error))
        {
            throw new SearchEngine_ErrorException(
                ...
                SearchEngine_ErrorException::RESPONSE_API_ERROR
            );
        }
        ...
        if (!isset($response->kind) || $response->kind != self::KIND)
        {
            throw new SearchEngine_ErrorException(
                ...
                SearchEngine_ErrorException::RESPONSE_KIND_INVALID
            );
        }
        ...
        if (isset($response->queries))
        {
            if (!($response->queries instanceof stdClass))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::RESPONSE_QUERIES_INVALID
                );
            }
        ...
        if (isset($response->promotions))
        {
            if (!is_array($response->promotions))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::RESPONSE_PROMOTIONS_INVALID
                );
            }
        ...
        if (isset($response->context))
        {
            if (!($response->context instanceof stdClass))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::RESPONSE_CONTEXT_INVALID
                );
            }
            
            $this->context = new SearchEngine_Response_Context($response->context);
        }
        ...
        if (isset($response->items))
        {
            if (!is_array($response->items))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::RESPONSE_ITEMS_INVALID
                );
            }
    ...
    {
        $queriesData = array(
            array('query' => 'request', 'errorCode' => SearchEngine_ErrorException::QUERY_REQUEST_INVALID),
            array('query' => 'nextPage', 'errorCode' => SearchEngine_ErrorException::QUERY_NEXTPAGE_INVALID),
            array('query' => 'previousPage', 'errorCode' => SearchEngine_ErrorException::QUERY_PREVIOUSPAGE_INVALID)
        );
        ...
        foreach($queriesData as $queryData)
        {
            if (isset($queries->{$queryData['query']}))
            {
                ...
                $this->queries[$queryData['query']] = new SearchEngine_Response_Query($queries->{$queryData['query']}[0]);
            }
        }
    }
        ...
        foreach($promotions as $key => $promotion)
        {
            if (!($promotion instanceof stdClass))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::PROMOTION_INVALID
                );
            }

            $promotionObject = new SearchEngine_Response_Promotion($promotion);
        ...
        foreach($results as $key => $result)
        {
            if (!($result instanceof stdClass))
            {
                throw new SearchEngine_ErrorException(
                    ...
                    SearchEngine_ErrorException::ITEM_INVALID
                );
            }

            $resultObject = new SearchEngine_Response_Result($result);
     ...
     * 
     * @return SearchEngine_Response_Context
     */
     ...
     * 
     * @param string $query
     * @return SearchEngine_Response_Query
