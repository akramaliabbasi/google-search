...
class SearchEngine_ErrorException extends RuntimeException
{
    // ------------------------------------------------------
    // Constants
    // ------------------------------------------------------
    ...
    /**
     * SearchEngine_Adapter_File_Get_Contents
     */
    const ADAPTER_FILE_GET_CONTENTS_EXECUTE_FAILED = 4;

    /**
     * SearchEngine_Response
     */
