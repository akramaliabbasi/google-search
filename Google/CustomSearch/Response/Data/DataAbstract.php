...
abstract class SearchEngine_Response_DataAbstract
{
    ...
    /**
     * Creates a new SearchEngine_Response_DataAbstract
     *
     * @param stdClass $responseData
     */
     ...
     * @param boolean $data
     * @return mixed
     * @see SearchEngine_Response_DataAbstract::toArray()
     */
