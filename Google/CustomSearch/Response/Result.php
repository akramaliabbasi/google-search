...
/**
 * SearchEngine_Response_Result parses and defines a "item" in the API response
 *
 * @author Akram Abbasi <mohdakramabbasi@gmail.com>
 * @link https://code.google.com/apis/customsearch/v1/reference.html
 */
class SearchEngine_Response_Result extends SearchEngine_Response_DataAbstract
{
    // ------------------------------------------------------
    // Constants
    // ------------------------------------------------------
    ...
    /**
     * @var SearchEngine_Response_Result_PageMap
     */
    protected $pagemap;
    ...
    protected function parse(stdClass $resultData)
    {
        if (!isset($resultData->kind) || $resultData->kind != self::KIND)
        {
            throw new SearchEngine_ErrorException(
                ...
                SearchEngine_ErrorException::ITEM_KIND_INVALID
            );
        }
        ...
        {
            $pagemap = new SearchEngine_Response_Result_PageMap($pagemap);
     ...
     *
     * @return SearchEngine_Response_Result_PageMap
