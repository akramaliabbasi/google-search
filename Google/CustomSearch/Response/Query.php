...
/**
 * SearchEngine_Response_Query parses and defines a "query" in the API response
 * 
 * @author Akram Abbasi <mohdakramabbasi@gmail.com>
 * @link https://code.google.com/apis/customsearch/v1/reference.html
 */
class SearchEngine_Response_Query extends SearchEngine_Response_DataAbstract
{
    // ------------------------------------------------------
    // Properties
    // ------------------------------------------------------
     ...
     *
     * @return string
     * @see SearchEngine::SAFE_MODE_ACTIVE,
     *      SearchEngine::SAFE_MODE_MODERATE,
     *      SearchEngine::SAFE_MODE_OFF
     */
