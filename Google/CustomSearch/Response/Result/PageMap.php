...
/**
 * SearchEngine_Response_Result_PageMap parses and defines a "pagemap" in the API response
 * 
 ...
 */
class SearchEngine_Response_Result_PageMap extends SearchEngine_Response_DataAbstract
{
    // ------------------------------------------------------
    // Properties
    // ------------------------------------------------------
    ...
    protected function parse(stdClass $resultData)
    {
        ...
        foreach($pageMapDataObjects as $key => $pageMapDataObject)
        {
            ...
            {
                $this->dataObjects[$key] = new SearchEngine_Response_Result_PageMap_DataObject($pageMapDataObject[0]);
            }
        }
    }
     ...
     * 
     * @param string $key
     * @return SearchEngine_Response_Result_PageMap_DataObject
     */
