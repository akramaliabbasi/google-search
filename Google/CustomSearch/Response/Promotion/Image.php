...
/**
 * SearchEngine_Response_Promotion_Image parses and defines a "promotion" "image" in the API response
 *
 * @author Akram Abbasi <mohdakramabbasi@gmail.com>
 * @link https://code.google.com/apis/customsearch/v1/reference.html
 */
class SearchEngine_Response_Promotion_Image extends SearchEngine_Response_DataAbstract
{
    // ------------------------------------------------------
    // Properties
    // ------------------------------------------------------
